...
export function addMoon({ pixiJsApp }) {
  // Create a moon graphics object from an SVG code.
  const graphics = new Graphics().svg(moonSvgCode);

  graphics.x = pixiJsApp.screen.width / 2 + 100;
  graphics.y = pixiJsApp.screen.height / 8;
